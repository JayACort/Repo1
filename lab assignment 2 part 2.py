# -*- coding: utf-8 -*-
"""
Created on Thu Sep 14 22:40:44 2023
...
## Comments by Jermaine Cort   
## Dirichlet BC is less tapored off than Newman BC. 
## Adding in the BC changes how the beginning and end of the slope is
## Changing the sigma to .5 changes the stability of the graph. The graph isn't as smooth anymore on either BC
## Chanigng the plot frequency to 40 changes the number of times in the plot 